...
What the loop is going to do is that is going to go over every single elemens and site list _a and print each variable separately under the name of our
